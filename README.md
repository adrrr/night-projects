...
Jeu de précision ultra-minimaliste — l'exact opposé visuel de Dead Stop : encre noire sur papier près-blanc, zéro neon, zéro particule, un seul chiffre. Une fine aiguille (1px) traverse toute la page et tourne à vitesse constante autour du centre ; une ligne d'horizon discrète la croise à l'horizontale. Tu n'as qu'UN tap, qu'UNE chance : fige l'aiguille PILE sur la ligne. Personne ne peut être parfaitement dessus — tout est de savoir qui s'en rapproche le plus, mesuré en degrés au dix-millième près. Quand l'aiguille est parfaitement à plat, les deux traits fusionnent en un seul trait pleine largeur. Deux modes via un toggle minimaliste : **Daily** (défi seedé déterministe à partir de la date UTC — tout le monde reçoit la même aiguille aujourd'hui, classement du jour qui se réinitialise à minuit UTC) et **Global** (aiguille aléatoire à chaque essai, top 10 all-time). Leaderboard top 10 par mode (Cloudflare Worker + KV) : un score qualifié → tu inscris tes initiales façon arcade, ta ligne surlignée sur le tableau. Hairlines crispes gérées au devicePixelRatio, mouvement en delta-time (identique à 60 et 120 Hz), Web Audio discret + mute, record perso en localStorage, rate-limit anti-flood côté serveur. Mobile-first (tap) + desktop (clic/espace). Trivial à apprendre, impossible à maîtriser.
